...
<form class="example" method="get" action="display.php" style="margin:auto;max-width:220px">
  <input type="text" placeholder=" Search SSM..." name="cssm" id="cssm" >
  ...
  <main id="main" class="main-page">
   ...
   <div align="center">
     ...
     <table  bordercolor="#000" border="1" align="center">
		<img src="img/44.png" style="width:60%"> 
       <tr>
         <th><div>
...
$conn = mysqli_connect("localhost", "root", "", "ibewebsite");
  ...
  if ($result->num_rows > 0) {
   ...
   while($row = $result->fetch_assoc()) {
    echo "<tr><td>" . $row["cssm"] . "</td><td>" . $row["cname"]. "</td> <td>" . $row["cevent"]. "</td><td>" . $row["cdate"]. "</td>
	<td>" . $row["ccontact"]. "</td>
